                            ...
                            <c:forEach var="auteur" items="${auteurs}">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="${pageContext.request.contextPath}/auteurs/delete/${auteur.id}" class="btn btn-sm btn-outline-danger" onclick="return confirm('Supprimer?')"><i class="bi bi-trash"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
